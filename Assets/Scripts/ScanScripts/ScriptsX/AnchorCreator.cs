...
public class AnchorCreator : MonoBehaviour
{
    ...
    private bool Pos2Anchor(float x, float y, BoundingBox outline)
    {
        ...
        anchorObj_mesh.text = $"{outline.Label}: {(int)(outline.Confidence * 100)}% Confidence"; //THIS IS WHERE YOU WOULD INSERT CALORIECOUNT TEXT (AFTER CAL DATABASE IS CREATED)****** {(float)(outline.CalorieCount)}
        // Perform the raycast
